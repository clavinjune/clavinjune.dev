...
I’ve just woke up and somehow I remembered when I created [taboo](/blogs/creating-taboo-error-handler-for-go/) to trace the error log. And then I think, would it be better if I pass the logger instead of the error log itself?
